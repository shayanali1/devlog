...
function NewLog() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-4xl font-bold text-on-surface/20 font-sans mb-1">Write Today's Win</h2>
      <p className="text-on-surface-variant mb-8">Document your progress and log your daily insights.</p>

      <div className="bg-surface-container/40 border border-outline-variant/30 rounded-xl p-8 flex flex-col gap-6">

        <div className="flex flex-col gap-2">
          <label className="text-xs font-mono uppercase tracking-wider text-on-surface-variant">Log Title</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs font-mono uppercase tracking-wider text-on-surface-variant">Topic Tag</label>
          <select
            value={tag}
            onChange={(e) => setTag(e.target.value)}
            className="bg-surface-variant/30 border border-outline-variant/50 rounded-lg px-4 py-3 text-on-surface focus:outline-none focus:border-primary/50 transition-colors font-sans"
          >
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs font-mono uppercase tracking-wider text-on-surface-variant">Log Body</label>
          <textarea
        ...
        <div className="flex flex-col gap-3">
          <label className="text-xs font-mono uppercase tracking-wider text-on-surface-variant">How are you feeling?</label>
